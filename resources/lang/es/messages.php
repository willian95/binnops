...
return [
    ...
    */
    ...
    "banner1" => "Binnops construye Gemelos Digitales Inteligentes de los activos industriales existentes para mejorar la eficiencia operativa, reducir los costos de operación y mantenimiento con el fin de mitigar riesgos.",
    "banner2" => "Construimos modelos 3D de plantas industriales utilizando técnicas de ingeniería inversa y luego vinculamos sus elementos virtuales con sus componentes en tiempo real.",
    "banner3" => "La alta cantidad de datos recogidos de la operación se procesan para generar información valiosa.",
    "banner4" => "En Binnops somos expertos en la producción de Gemelos Digitales Inteligentes que responden a las necesidades de Ingeniería, Operaciones, Mantenimiento y Gestión de Activos.",
    "banner5" => "La tecnología, desde el escaneo láser hasta el Internet de las Cosas y la Gestión del Cambio, es madura, funcional, rentable y probada. El uso de Gemelos Digitales con datos centralizados de Ingeniería, operaciones de planta y la gestión de activos es la 'next big thing'.",
    "banner6" => "Binnops ha desarrollado más de 50 proyectos para clientes internacionales, que generan menores costos operativos, mejora la eficiencia y aumenta la confiabilidad. ",
    "banner7" => "La arquitectura informática de Binnops, incluye modelos virtuales en 3D de cualquier tipo de activo, está cambiando la forma de trabajar, sustituyendo las representaciones abstractas en 2D, como layouts, dibujos isométricos, P&ID's, etc; por elementos virtuales. Esta es la forma más avanzada de implementar un verdadero Proceso de Transformación Digital.",
    "assetVisualization" => "Visualización de activos",
    "smartTwins" => "Gemelos Digitales Inteligentes",
    "smartManagement" => "Smart Data Management",
    "backServices" => "Volver a servicios",
    "saveMoney" => "Ahorre dinero y mejore sus decisiones recorriendo virtualmente su activo y observe la condición real de construcción. Binnops ofrece una plataforma de recorrido para visualizar su activo a través de Internet.",
    "viewMore" => "Ver más",
    ...
    "daas" => "por Data As a Service",
    "dataasservice" => "Data como Servicio",
    "sellingData" => "Binnops también ofrece una opción comercial moderna mediante la venta de datos como servicio. La Visualización De Activos y los Gemelos Digitales se pueden disfrutar accediendo a los datos a través de la web y pagando una tarifa recurrente por mes.",
    "transformationRoadMap" => "Nuestra ruta de Transformación Digital",
    "dataCapture" => "Captura de Datos",
    "digitalTwin" => "Gemelo digital",
    "realTimeCapture" => "Captura en Tiempo Real",
    ...
    "usOffice" => "Oficina en Estados Unidos",
    "colombiaOffice" => "Oficina en Colombia",
    "address" => "Subsidiario de E2 SAS Colombia - 2101 City West Boulevard, Suite 100 77042 Houston Texas",
    "name" => "Nombre",
    ...
    "aerialScanningDescription" => "Este proceso se puede realizar para recopilar datos sensibles como temperaturas, emisiones de gases o simplemente para inspeccionar estructuras elevadas con difícil acceso. Los datos de las nubes de puntos se generan en formato LAS o Recap, los cuales se pueden entregar en formatos GIS.",
    "assetVisualization3" => "Las nubes de puntos y las fotografías 4K del activo se cargan en el portal de visualización de Binnops para generar una navegación fácil de usar. Nuestros clientes pueden acceder de forma remota y sin necesidad de ningún software. Los usuarios del cliente pueden ingresar simultáneamente al activo y navegar con otros miembros del equipo. ",
    "digitalHubDescription1" => "Una vez creado el gemelo digital, el próximo desafío será la simplificación del proceso para facilitar el uso de datos complejos. Los usuarios deben encontrar la aplicación tan intuitiva y fácil de usar como un videojuego. Una vez que se llenan y se completan todas las bases de datos de ingeniería, el modelo geométrico o inteligente se carga en una plataforma en la web para facilitar la navegación y la gestión de datos.",
